<template>
  <div class="centered-container">
    <md-content class="md-elevation-3">
      <div class="title">
        <img src="@/assets/logo-kl-lazismu-smp-mds.jpg" />
        <div class="md-title">Lazizmu Admin MDS</div>
        <div class="md-body-1">
          Sudah punya akun?
      ...
      <div class="form">
        <md-field>
          <label>Nama</label>
          <md-input v-model="reg.username" autofocus></md-input>
        </md-field>

        <md-field>
          <label>No Telp</label>
          <md-input v-model="reg.mobilePhoneNumber" autofocus></md-input>
        </md-field>

        <md-field>
          <label>E-mail</label>
          <md-input
            v-model="reg.emailAddress"
            autofocus
            type="email"
          ></md-input>
        </md-field>
        ...
        <md-field md-has-password>
          ...
          <md-input v-model="reg.passwordHash" type="password"></md-input>
        </md-field>
      </div>
