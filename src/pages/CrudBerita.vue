  ...
  <div class="all">
    ...
    <div class="content" v-if="tambahBerita === false">
      <md-table md-card>
        ...
        <md-table-row class="body" v-for="(data, index) in berita" :key="index">
          <md-table-cell>{{ data.kategori }}</md-table-cell>
        ...
        <div class="body">
          <md-field>
            ...
            <md-select v-model="dataForm.kategori" md-dense>
              ...
              <md-option value="Sosial">Sosial</md-option>
              <md-option value="Pendidikan">Pendidikan</md-option>
            </md-select>
          </md-field>
          <md-field>
            <label>Judul</label>
